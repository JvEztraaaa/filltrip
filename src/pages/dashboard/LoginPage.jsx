...
export default function LoginPage() {
  ...
  const handleFacebookLogin = async () => {
    ...
    try {
      ...
      setSubmitError('Facebook login failed. Please try again.');
    }
  };
      ...
      <div
        ...
        style={{
          background: window.innerWidth >= 1024
            ? 'linear-gradient(to top, rgba(22,138,138,0.6) 0%, rgba(22,138,138,0.4) 20%, rgba(22,138,138,0.2) 40%, rgba(22,138,138,0.1) 60%, transparent 80%)'
            : 'none',
        }}
      >
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="flex flex-col items-center">
            <img alt="Your Company" src="/images/logo.svg" className="mx-auto h-14 w-auto mb-4" />
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            ...
            <div className="flex items-center">
              <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-[#168A8A] focus:ring-[#4FD1C5]" />
