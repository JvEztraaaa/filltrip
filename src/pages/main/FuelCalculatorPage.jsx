...
const FuelCalculatorPage = () => {
  ...
  <div className="pt-20 pl-0 md:pl-64 w-full">
        ...
        <header className="max-w-3xl mb-6">
          ...
          <p className="text-gray-400 text-sm mt-2 max-w-prose">Follow the numbered steps, then press Calculate. Actions, results, and quick tips stay visible on the right for zero scrolling on desktop.</p>
        </header>
  <div className="flex flex-col xl:flex-row gap-6 items-start">
          ...
          <div className="flex-1 space-y-6 xl:pr-4 max-w-2xl w-full mx-auto">
            ...
            {/* Placeholder div to help maintain vertical rhythm on small screens when summary moves below */}
            <div className="h-px" />
          </div>
