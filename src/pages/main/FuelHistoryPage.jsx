    ...
    <div className="relative min-h-screen w-full bg-gray-900 text-white overflow-x-hidden">
      ...
      <div className={`pt-20 w-full transition-all duration-300 ${
        ...
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          {/* Header Section - Clean design like Statistics page */}
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex flex-col">
                <h1 className="text-2xl font-semibold tracking-tight text-white">Fuel History</h1>
                <p className="text-gray-400 text-sm">Keep track of every fuel-up to monitor your vehicle's consumption patterns and fuel costs over time</p>
              </div>
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-700/50 hover:bg-gray-600/50 border border-gray-600/50 hover:border-gray-500/50 text-gray-300 hover:text-white font-medium transition-all duration-200"
                >
          ...
          <div className="bg-gray-800/40 border border-gray-700/50 rounded-xl p-4 md:p-6 mb-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
              <div>
                <h2 className="text-lg font-medium text-white">Recent Entries</h2>
                <p className="text-sm text-gray-400">Fuel-up records grouped by month</p>
              </div>
              <button
                onClick={() => setAddModalOpen(true)}
                className="flex items-center justify-center gap-2 px-3 py-2 sm:px-4 sm:py-2 rounded-lg bg-gradient-to-r from-teal-500 to-indigo-600 hover:from-teal-400 hover:to-indigo-500 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-200 text-sm sm:text-base"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
          ...
          {groups.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-sm text-gray-400 max-w-md mx-auto">
                  Start tracking your fuel consumption by adding your first entry above. You'll be able to see patterns and trends over time.
                </p>
              </div>
            ) : (
                ...
                <div key={g.key} className="space-y-4">
                  <div className="flex items-center gap-4 py-3">
                    <button
                      ...
                      className="flex items-center gap-3 hover:bg-gray-700/20 rounded-lg p-2 -ml-2 transition-colors group"
                    >
                      <svg
                    ...
                    <div className="flex-1 h-px bg-gradient-to-r from-gray-600/30 to-transparent"></div>
                    <span className="text-xs text-gray-400 bg-gray-700/20 px-2 py-1 rounded-full">
                    ...
                    <div className="space-y-3 pl-6">
                      {g.items.map((e, index) => {
                        ...
                        return (
                          <div
                            key={e.id}
                            className={`group relative bg-gray-800/30 backdrop-blur-sm rounded-lg border transition-all duration-300 hover:bg-gray-800/50 ${
                              isLatest
                          ...
                          >
                            {isLatest && (
                              <div className="absolute -top-2 -right-2 bg-gradient-to-r from-teal-500 to-indigo-500 text-white text-xs font-medium px-2 py-1 rounded-full shadow-sm">
                                Latest
                              </div>
                            )}
          ...
          <div className="bg-gray-800 rounded-xl shadow-2xl w-full max-w-[95vw] sm:max-w-3xl lg:max-w-4xl max-h-[92vh] overflow-y-auto border border-gray-700/40">
            ...
            <div className="p-4 sm:p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">
                    Price per {form.fuelUnit === "liters" ? "Liter" : "Gallon"}
                  </label>
                  <div className="flex rounded-lg focus-within:ring-1 focus-within:ring-teal-500">
                    <input
                      type="number"
                ...
                <div>
                  ...
                  {autoTotal > 0 && !form.totalCost && (
                    <p className="text-xs text-teal-400 mt-1">
                      Auto-calculated: {symbol}{autoTotal.toFixed(2)}
                    </p>
                  )}
                </div>
