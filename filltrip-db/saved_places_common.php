...
/**
 * saved_places_common.php
 * ------------------------------------------------------------------
 * Shared helper utilities for saved_places* endpoints (CORS, session,
 * DB connection, input parsing, schema inspection).
 */
...
function sp_pdo(): PDO {
  // Matches configuration used by other endpoints.
  return new PDO('mysql:host=127.0.0.1;dbname=filltrip;charset=utf8mb4', 'root', '', [
