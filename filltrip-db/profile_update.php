 ...
 * profile_update.php
 * ------------------------------------------------------------------
 * Updates basic user profile fields (first/last/username/email).
 * Requires active session; enforces email + username uniqueness excluding self.
 */
...
if ($missing) {
  ...
  echo json_encode(['success'=>false,'error'=>'Invalid input','missing'=>$missing]);
  exit;
}
